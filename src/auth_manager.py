...
Quản lý authentication logic với Firebase Auth
"""
...
class AuthManager:
    ...
    def verify_user(self, email: str, password: str) -> tuple[bool, Optional[str], Optional[str]]:
        ...
        Note: Firebase Admin SDK không hỗ trợ sign-in trực tiếp.
        Trong production, bạn nên sử dụng Firebase Client SDK hoặc custom token.
        Ở đây tôi sử dụng workaround với Admin SDK.
    ...
    def reset_password(self, email: str) -> tuple[bool, str]:
        ...
        Note: Admin SDK không hỗ trợ send email trực tiếp.
        Cần setup Firebase Auth email templates và dùng Client SDK.
